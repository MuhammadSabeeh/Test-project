...
namespace UnitTestingAppInMVC.Tests.Controllers
{
    ...
    public class EmployeeControllerTest
    {
        ...
        {
            return GetEmployeeName(88, "Rahul Saxena", "rahulsaxena@live.com", "Software Developer", "Noida", "Uttar Pradesh", "India");
        }

        /// <summary>    
        ///    This Method is use for Post Redirect 
        /// </summary>    
        [TestMethod]
        ...
        /// <summary>    
        ///   This Method is use for View is not Valid
        /// </summary>    
        [TestMethod]
